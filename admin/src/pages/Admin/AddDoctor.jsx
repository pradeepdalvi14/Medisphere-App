...
const AddDoctor = () => {
    ...
    const onSubmitHandler = async(e)=>{
        ...
        try {
            ...
            formData.append('image',docImg);//multer madhe use kela hota
  ...
  return (
    <form onSubmit={onSubmitHandler} action="" className='m-5 w-full ' >
        ...
        <div className='bg-white px-8 py-8 shadow-xl rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
            ...
            <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600 '>
                ...
                <div className='lg:flex-1 flex flex-col w-full gap-4'>
                    <div className='flex-1 flex flex-col gap-1'>
                        <p>Speciality</p>
